...
\def\dozec{330} % 12*\sz - 6
    ...
    \node [rectangle, minimum width=10pt, minimum   height=35pt] at (570pt,-12*\altura) {8};
    ...
    \node [rectangle, minimum width=10pt, minimum   height=35pt] at (570pt,-13*\altura) {8};
    ...
    \node (lastcred) [rectangle, minimum width=10pt, minimum   height=35pt] at (570pt,-14*\altura) {12};
