...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        \hline
        \multicolumn{2}{|l|}{Atividades de extensão e cultura do BC\&T}      & 240 \\
        \hline
        \multicolumn{2}{|l|}{Atividades de extensão e cultura do BCC}      & 104 \\
      % \hline
      %   \multicolumn{2}{|l|}{Atividades de extensão e cultura - total}      & 343 \\
      \hline
        \multicolumn{2}{|l|}{\textit{Carga horária total}}               & \textbf{3.434}\\
        \hline
    \end{tabular}
\end{table}
A soma da carga horária de extensão do BC\&T com a do BCC resulta em $344$ horas, $10\%$
