...
totalizam \red{XXXX} horas: ($i$) disciplinas, ($ii$) atividades de extensão e
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        \hline\hline
        Disciplinas obrigatórias do BC\&T         & 84                & 1008 \\
        \hline
        Disciplinas obrigatórias do BCC           & 118               & 1416 \\
        \hline
        Disciplinas de opção limitada do BCC      & 24                & 288 \\
        \hline
        Disciplinas livres                        & 8                 & 96 \\
        \hline
        \textit{Total}                            & 234               & \\
        \hline\hline
        Atividades de extensão e cultura do BC\&T & 20                & 240 \\
        \hline
        Atividades complementares do BC\&T        & 4                 & 48 \\
        \hline
        \textit{Total}                            & 258               & 3096 \\
        \hline
    \end{tabular}
\end{table}
...
O projeto pedagógico prevê, ainda, \red{XX\%} de carga horária em disciplinas
livres e de opção limitada, em que o(a) aluno(a) poderá escolher os componentes
...
Seção~\ref{sec:disciplinas_obrigatorias_ementas}.
