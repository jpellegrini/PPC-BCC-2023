...
A regulamentação, critérios de matrícula, procedimentos, mecanismo de avaliação e diretrizes do TCC são regidos pela \red{Resolução no XXXXX/XXXX} ou documento mais recente que a substitua. 
