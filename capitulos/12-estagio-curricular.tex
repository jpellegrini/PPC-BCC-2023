...
Os critérios de aproveitamento, documentação, renovação (quando cabível) e orientação de estágio supervisionado são definidos pela \red{Resolução no. XXXXX/XXXX} ou documento mais recente que a substitua.
